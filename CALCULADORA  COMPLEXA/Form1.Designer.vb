...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' Btt1
        ' 
        Btt1.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        ...
        BttVEZES.Text = "X"
        BttVEZES.UseVisualStyleBackColor = True
        ' 
        ' BttIGUAL
        ' 
        ...
        BttIGUAL.Text = "="
        BttIGUAL.UseVisualStyleBackColor = True
        ' 
        ' BttMAIS
        ' 
        ...
        BttMAIS.TabIndex = 13
        BttMAIS.Text = "+"
        BttMAIS.UseVisualStyleBackColor = True
        ' 
        ' BttSQR
        ' 
        ...
        BttMENOS.Text = "-"
        BttMENOS.UseVisualStyleBackColor = True
        ' 
        ' BttDIVIDIR
        ' 
        ...
        BttDIVIDIR.Text = ":"
        BttDIVIDIR.UseVisualStyleBackColor = True
        ' 
        ' BttC
        ' 
        ...
        BttC.TabIndex = 17
        BttC.Text = "c"
        BttC.UseVisualStyleBackColor = True
        ' 
        ' BttPONTO
        ' 
        ...
        BttPONTO.Text = ","
        BttPONTO.UseVisualStyleBackColor = True
        ' 
        ' BttELEVADO
        ' 
        ...
        BttELEVADO.Text = "e^"
        BttELEVADO.UseVisualStyleBackColor = True
        ' 
        ' BttSIN
        ' 
        ...
        BttSIN.TabIndex = 23
        BttSIN.Text = "sin"
        BttSIN.UseVisualStyleBackColor = True
        ' 
        ' BttCOS
        ' 
        ...
        BttCOS.TabIndex = 22
        BttCOS.Text = "cos"
        BttCOS.UseVisualStyleBackColor = True
        ' 
        ' BttPI
        ' 
        ...
        BttPI.TabIndex = 21
        BttPI.Text = "π"
        BttPI.UseVisualStyleBackColor = True
        ' 
        ' BttFR
        ' 
        ...
        BttFR.TabIndex = 20
        BttFR.Text = "FR"
        BttFR.UseVisualStyleBackColor = True
        ' 
        ' BttSQRELE
        ' 
        ...
        BttSQRELE.Text = "√^x"
        BttSQRELE.UseVisualStyleBackColor = True
        ' 
        ' BttCOS1
        ' 
        ...
        BttCOS1.TabIndex = 36
        BttCOS1.Text = "cos^-1"
        BttCOS1.UseVisualStyleBackColor = True
        ' 
        ' BttTAN
        ' 
        ...
        BttTAN.TabIndex = 35
        BttTAN.Text = "tan"
        BttTAN.UseVisualStyleBackColor = True
        ' 
        ' BttTAN1
        ' 
        ...
        BttTAN1.TabIndex = 34
        BttTAN1.Text = "tan^-1"
        BttTAN1.UseVisualStyleBackColor = True
        ' 
        ' BttSIN1
        ' 
        ...
        BttSIN1.TabIndex = 33
        BttSIN1.Text = "sin^-1"
        BttSIN1.UseVisualStyleBackColor = True
        ' 
        ' BttRAD
        ' 
        ...
        BttRAD.TabIndex = 32
        BttRAD.Text = "Rad "
        BttRAD.UseVisualStyleBackColor = True
        ' 
        ' BttGRAUS
        ' 
        ...
        BttCONTAGENS.UseVisualStyleBackColor = True
        ' 
        ' BttLOG
        ' 
        ...
        BttLOG.TabIndex = 29
        BttLOG.Text = "log"
        BttLOG.UseVisualStyleBackColor = True
        ' 
        ' BttSD
        ' 
        ...
        BttFATORIAL.Text = "n!"
        BttFATORIAL.UseVisualStyleBackColor = True
        ' 
        ' Form1
        ' 
